#incluo libs do jogo
from model import directorEnemy
#- Inimigos
from model import mrSalaminhoBuilder
from model import srBilugoBuilder
from model import paulusBuilder
from model import piruletaBuilder
from model import reiDaCacimbinhaBuilder
from model import leposLepusBuilder
#Fabrica de inimigos
class EnemyFactory():
